...
- [x] **01-contracts** - Event schemas and agent contracts (2024-12-08)
- [x] **02-event-store** - EventLogWriter and projections (2024-12-08)
- [x] **03-runtime-core** - TurnRunner and stages (2024-12-08)
- [x] **04-workspace** - Workspace and reducer (2024-12-08)
- [x] **05-agents** - Agent manifests and execution (2024-12-08)
- [x] **06-deliberation** - Claim-based deliberation (2024-12-08)
- [x] **07-council-voice** - Council and voice rendering (2024-12-08)
- [x] **08-memory** - Memory system (2024-12-08)
...
#### 01-contracts
- [x] Create `src/rilai/contracts/__init__.py`
- [x] Create `src/rilai/contracts/events.py` (EventKind, EngineEvent)
- [x] Create `src/rilai/contracts/agent.py` (AgentOutput, Claim, AgentManifest)
- [x] Create `src/rilai/contracts/sensor.py` (SensorOutput)
- [x] Create `src/rilai/contracts/workspace.py` (StanceVector, GlobalModulators)
- [x] Create `src/rilai/contracts/council.py` (CouncilDecision, SpeechAct)
- [x] Create `src/rilai/contracts/memory.py` (MemoryCandidate, EpisodicEvent)
- [x] Run tests for contracts

#### 02-event-store
- [x] Create `src/rilai/store/__init__.py`
- [x] Create `src/rilai/store/event_log.py` (EventLogWriter)
- [x] Create `src/rilai/store/projections/__init__.py`
- [x] Create `src/rilai/store/projections/base.py`
- [x] Create `src/rilai/store/projections/turn_state.py`
- [x] Create `src/rilai/store/projections/session.py`
- [x] Create `src/rilai/store/projections/analytics.py`
- [x] Create `src/rilai/store/projections/debug.py`
- [x] Run tests for event store
- [ ] Delete v2 files: `memory/database.py`, `memory/short_term.py`, `observability/store.py`

#### 03-runtime-core
- [x] Create `src/rilai/runtime/__init__.py`
- [x] Create `src/rilai/runtime/turn_runner.py`
- [x] Create `src/rilai/runtime/stages.py`
- [x] Create `src/rilai/runtime/scheduler.py`
- [x] Run tests for runtime core
- [ ] Delete v2 files: `core/engine.py`, `core/events.py`

#### 04-workspace
- [x] Create `src/rilai/runtime/workspace.py`
- [x] Create `src/rilai/runtime/reducer.py`
- [x] Create `src/rilai/runtime/stance.py`
- [x] Create `src/rilai/runtime/modulators.py`
- [x] Run tests for workspace
- [ ] Delete v2 files: `core/stance.py`, `core/stance_aggregator.py`, `brain/modulators.py`

#### 05-agents
- [x] Create `src/rilai/agents/__init__.py`
- [x] Create `src/rilai/agents/manifest.py`
- [x] Create `src/rilai/agents/base.py`
- [x] Create `src/rilai/agents/executor.py`
- [x] Create `src/rilai/agents/registry.py`
- [x] Create example agent manifest (stress.yaml + stress.md)
- [x] Run tests for agents
- [ ] Delete v2 files: `agents/protocol.py`, `agents/base.py` (old)
- [ ] Delete v2 folder: `agencies/`

#### 06-deliberation
- [x] Create `src/rilai/runtime/deliberation.py`
- [x] Create `src/rilai/runtime/argument_graph.py`
- [x] Run tests for deliberation
- [ ] Delete v2 files: `council/deliberation.py`, `council/collector.py`

#### 07-council-voice
- [x] Create `src/rilai/runtime/council.py`
- [x] Create `src/rilai/runtime/voice.py`
- [x] Create `src/rilai/runtime/critics.py`
- [x] Run tests for council and voice
- [ ] Delete v2 files: `council/pipeline.py`, `council/synthesizer.py`, `council/voice.py`

#### 08-memory
- [x] Create `src/rilai/memory/__init__.py`
- [x] Create `src/rilai/memory/retrieval.py`
- [x] Create `src/rilai/memory/episodic.py`
- [x] Create `src/rilai/memory/user_model.py`
- [ ] Create `src/rilai/memory/consolidation.py`
- [x] Create `src/rilai/memory/embeddings.py`
- [x] Run tests for memory

#### 09-tui
- [x] Create `src/rilai/ui/__init__.py`
- [ ] Create `src/rilai/ui/app.py` (pending integration)
- [x] Create `src/rilai/ui/projection.py`
- [x] Create `src/rilai/ui/panels/__init__.py`
- [x] Create `src/rilai/ui/panels/chat.py`
- [x] Create `src/rilai/ui/panels/sensors.py`
- [x] Create `src/rilai/ui/panels/stance.py`
- [x] Create `src/rilai/ui/panels/agents.py`
- [x] Create `src/rilai/ui/panels/activity.py`
- [x] Create `src/rilai/ui/panels/critics.py`
- [ ] Update `src/rilai/cli.py` (pending integration)
- [x] Run tests for TUI
- [ ] Delete v2 folder: `tui/`

#### 10-daemon
- [x] Create `src/rilai/daemon/__init__.py`
- [x] Create `src/rilai/daemon/brain.py`
- [x] Create `src/rilai/daemon/nudges.py`
- [x] Create `src/rilai/daemon/decay.py`
- [x] Run tests for daemon

#### 11-migration
- [ ] Backup v2 to branch
- [ ] Run database migration script
- [ ] Create all 49 agent prompts (3/49 created: stress, wellbeing, empathy)
